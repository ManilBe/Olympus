...
public class OlympusGrassBlock extends OlympusElements.ModElement {
	@ObjectHolder("olympus:olympus_grass")
	public static final Block block = null;
	public OlympusGrassBlock(OlympusElements instance) {
		super(instance, 8);
	}
