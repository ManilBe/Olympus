...
public class OlympusDirtBlock extends OlympusElements.ModElement {
	@ObjectHolder("olympus:olympus_dirt")
	public static final Block block = null;
	public OlympusDirtBlock(OlympusElements instance) {
		super(instance, 10);
	}
