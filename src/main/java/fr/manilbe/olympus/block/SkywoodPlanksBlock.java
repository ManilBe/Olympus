...
public class SkywoodPlanksBlock extends OlympusElements.ModElement {
	@ObjectHolder("olympus:skywood_planks")
	public static final Block block = null;
	public SkywoodPlanksBlock(OlympusElements instance) {
		super(instance, 5);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("skywood_planks");
		}
