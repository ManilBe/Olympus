...
package fr.manilbe.olympus.world.dimension;
...
import fr.manilbe.olympus.item.OlympusItem;
...
public class OlympusDimension extends OlympusElements.ModElement {
	@ObjectHolder("olympus:olympus")
	public static final ModDimension dimension = null;
	@ObjectHolder("olympus:olympus_portal")
	public static final CustomPortalBlock portal = null;
	public static DimensionType type = null;
	private static Biome[] dimensionBiomes;
	public OlympusDimension(OlympusElements instance) {
		super(instance, 3);
	...
	public void registerDimension(RegistryEvent.Register<ModDimension> event) {
		event.getRegistry().register(new CustomModDimension().setRegistryName("olympus"));
	}

	@SubscribeEvent
	public void onRegisterDimensionsEvent(RegisterDimensionsEvent event) {
		if (DimensionType.byName(new ResourceLocation("olympus:olympus")) == null) {
			DimensionManager.registerDimension(new ResourceLocation("olympus:olympus"), dimension, null, false);
		}
		type = DimensionType.byName(new ResourceLocation("olympus:olympus"));
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new OlympusItem().setRegistryName("olympus"));
	}
	public static class CustomPortalBlock extends NetherPortalBlock {
		public CustomPortalBlock() {
			...
			setRegistryName("olympus_portal");
		}
		...
		private TeleporterDimensionMod getTeleporterForDimension(Entity entity, BlockPos pos, ServerWorld nextWorld) {
			BlockPattern.PatternHelper bph = OlympusDimension.CustomPortalBlock.createPatternHelper(entity.world, new BlockPos(pos));
	...
	public void registerPointOfInterest(RegistryEvent.Register<PointOfInterestType> event) {
		try {
			...
			poi = (PointOfInterestType) method.invoke(null, "olympus_portal",
	...
	public static class TeleporterDimensionMod extends Teleporter {
		...
		public BlockPattern.PortalInfo placeInExistingPortal(BlockPos p_222272_1_, Vec3d p_222272_2_, Direction directionIn, double p_222272_4_,
			...
			return optional.map((p_226707_7_) -> {
				...
				BlockPattern.PatternHelper blockpattern$patternhelper = OlympusDimension.CustomPortalBlock.createPatternHelper(this.world, blockpos);
